...
skeleton2muscle = {
                   ...
                   '住院号': ['住院号为%s'],
                   '科室': ['科室为%s', '%s'],
                   '入院时间': ['入院时间为%s', '入院时间是%s', '入院日期为%s', '入院日期是%s', '住院时间为%s', '住院时间是%s', '住院日期为%s', '住院日期是%s'],
                   '床号': ['床号为%s', '床号是%s', '%s号床', '床号为%s号', '床号是%s号'],
                   '疾病诊断': ['%s'],
                   '检查报告名称': ['%s'],
                   # '检验报告名称': ['%s'],
                   '检验指标_att': ['%s'],
                   '医嘱类型': ['医嘱类型为%s'],
                   '送检时间': ['送检时间为%s', '送检时间是%s', '送检日期为%s', '送检日期是%s', '检验时间为%s', '检验时间是%s', '检验日期为%s', '检验日期是%s',
                               '检查时间为%s', '检查时间是%s', '检查日期为%s', '检查日期是%s',],
                   }
