...
attribute_list = [[['姓名'], ['病历号'], ['住院号'], ['科室', '入院时间', '床号'], ['姓名', '入院时间']],
                  [['疾病诊断']],
                  [['送检时间'], ['检验指标'], ['检验指标', '送检时间'], ['医嘱类型']], ]
objects_list = ['患者信息', '电子病历', '检查报告', '检验报告', '异常指标', '医嘱信息', '相似患者',
                '相关文献', '相关指南', ]
...
#
ban_rule_map = {'疾病诊断': {'患者信息', '电子病历', '检查报告', '检验报告', '异常指标', '医嘱信息', },
                '检查报告名称': {'患者信息', '电子病历', '检验报告', '异常指标', '医嘱信息', '相似患者', '相关文献', '相关指南', },
                # '检验报告名称': {'患者信息', '电子病历', '检查报告', '异常指标', '医嘱信息', '相似患者', '相关文献', '相关指南', },
                '送检时间': {'患者信息', '电子病历', '异常指标', '医嘱信息', '相似患者', '相关文献', '相关指南', '送检时间'},
                '检验指标': {'患者信息', '电子病历', '检查报告', '异常指标', '医嘱信息', '相似患者', '相关文献', '相关指南', },
                '医嘱类型': {'患者信息', '电子病历', '检验报告', '检查报告', '异常指标', '相似患者', '相关文献', '相关指南', },
...
intent_map = {'患者信息': 'request_patient_info',
              ...
              '相似患者': 'request_patient_similar_patient',
              '相关文献': 'request_patient_related_literature',
              '相关指南': 'request_disease_related_guide',
              '姓名': 'inform',
              '病历号': 'inform',
              '住院号': 'inform',
              '科室': 'inform',
